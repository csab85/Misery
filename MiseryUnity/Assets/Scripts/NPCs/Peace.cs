...
public class Peace: MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            case 0:
                speech = new string[] { "Olá pequenino!"};
